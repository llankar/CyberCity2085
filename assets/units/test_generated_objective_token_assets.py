...
MANIFEST = ROOT / "generated_objective_token_manifest.json"
EXPECTED_CATEGORIES = {
    "city_mission_objectives",
    "wasteland_mission_objectives",
}


class GeneratedObjectiveTokenAssetTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_each_category_has_ten_tokens(self):
        for category in self.manifest["categories"]:
            self.assertEqual(category["count"], 10, category["category"])
