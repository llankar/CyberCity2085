...
| research | Projects can be started, tick down, complete with unlock flags/modifiers; research tree now includes 21 projects across 7 branches for clearer progression pacing. | Richer project dependency display in UI. | Corp research room actions. | `tests/test_research_management.py`, e2e save/load flow |
