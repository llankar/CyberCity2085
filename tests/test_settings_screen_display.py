...
fake_arcade = types.SimpleNamespace(
    ...
    draw_text=lambda text, *args, **kwargs: captured_draw_text.append(str(text)),
...
class SettingsScreenDisplayTest(unittest.TestCase):
    ...
    def test_settings_round_trip_includes_display_index(self) -> None:
        state = settings_screen.SettingsState(display_index=1, resolution_index=2)
    ...
    def test_settings_panel_exposes_display_selector(self) -> None:
